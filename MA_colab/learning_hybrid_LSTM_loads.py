        ...
        for i in range(5):
            try:            
                for dirname in dirs:                
                    ...
                    station_1 = import_path + dirname + '/Loads/sum_red_header.csv'
                    station_2 = import_path + dirname + '/Loads/averages.csv'
                    ...
                    results.to_csv(export_path + "load_hybrid_exp_res_" + timestr + ".csv", encoding='utf-8')         
                ...
                # timestr = time.strftime("%Y%m%d_%H%M%S")       
                # summary.to_csv(export_path + timestr + ".csv", encoding='utf-8')                
                # summary = pd.DataFrame(columns=summary_cols)    
