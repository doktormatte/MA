            ...
            for i in range(5):    
                try:            
                    ...
                    for dirname in dirs:
                        ...
                        X_train,y_train,X_test,y_test = read_data('/content/data/Data/' + dirname + '/Loads/sum_red.csv', n_steps_in, n_steps_out, n_features, architecture)
                ...
                try:            
                    for dirname in dirs:                
                        ...
                        for j in range(1,53):
                            ...
                            num = j
                            try:
                                X_train,y_train,X_test,y_test = read_data('/content/data/Data/' + dirname + '/Occup/' + str(num) + '_red.csv', n_steps_in, n_steps_out, n_features, architecture)
                            except Exception:
                                continue                    
