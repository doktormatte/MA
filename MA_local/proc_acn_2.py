...
f = open('/home/doktormatte/Dropbox/Dokumente/Studium/MA_SciComp/Data/Original/acndata_sessions_jpl.json')
data = json.load(f)
sites = set()
...
#session_counts.to_csv('/home/doktormatte/MA_SciComp/ACN_2/Occup/session_counts.csv', encoding='utf-8', index=False)
