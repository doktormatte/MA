...
for dirname in dirs:
    for num in range(1,53):        
        try:
            ...
            filename = '/home/doktormatte/Dropbox/Dokumente/Studium/MA_SciComp/log_regress_model.sav'
            ...
            mean_pre = np.mean(res_all,axis=0)[1]
            mean_recall = np.mean(res_all,axis=0)[2]
            mean_f1 = np.mean(res_all,axis=0)[3]
            aux_scores = [mean_pre, mean_recall, mean_f1]
            ...
            result['scores'] = " ".join(str(x) for x in list(aux_scores))
...
results.to_csv("/home/doktormatte/Dropbox/Dokumente/Studium/MA_SciComp/log_regr_occup_exp_res_" + timestr + ".csv", encoding='utf-8')                
